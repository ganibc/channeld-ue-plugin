...
void UChanneldEditorSubsystem::GenerateReplicationAction()
{
	...
	AsyncTask(ENamedThreads::GameThread, [this]()
	{
		...
		if (FileManager.FileExists(*ClangFormatPath))
		{
			...
			TSharedPtr<FChanneldProcWorkerThread> ClangFormatThread = MakeShareable(new FChanneldProcWorkerThread(TEXT("RunClangFormatForRepCode"), ClangFormatPath, Args, ReplicatorStorageDir));
